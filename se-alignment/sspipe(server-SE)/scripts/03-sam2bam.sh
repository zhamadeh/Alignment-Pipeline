...
cd /home/zhamadeh/NEW_PAPER_OLD_DATA/se_alignment_pipeline/sorted

#assign input/output directories and process filenames
dir="/home/zhamadeh/NEW_PAPER_OLD_DATA/se_alignment_pipeline/sam/"
base=$(basename $1 ".sam")
out="/home/zhamadeh/NEW_PAPER_OLD_DATA/se_alignment_pipeline/sorted/"
...
samtools view -q10 -h ${dir}/${base}.sorted.bam chr1 chr2 chr3 chr4 chr5 chr6 chr7 chr8 chr9 chr10 chr11 chr12 chr13 chr14 chr15 chr16 chr17 chr18 chr19 chr20 chr21 chr22 chrX chrY |
        grep -v -E '@SQ.*chrUn|@SQ.*chrM|@SQ.*random|@SQ.*chrEBV' | samtools sort -n - | samtools fixmate -O bam - - | samtools sort - | samtools view -bh -o ${out}/${base}.sorted
