...
cd /home/zhamadeh/NEW_PAPER_OLD_DATA/pe_alignment_pipeline/sspipe/
...
ls /home/zhamadeh/NEW_PAPER_OLD_DATA/pe_alignment_pipeline/fastq/*1.fastq.gz | parallel --jobs $p bash "./scripts/01-trim-adapters.sh" {}
./scripts/02-pe-bowtie2-align.sh $p
ls /home/zhamadeh/NEW_PAPER_OLD_DATA/pe_alignment_pipeline/sam/*.sam | parallel --jobs $p bash "./scripts/03-sam2bam.sh" {} 
...
ls /home/zhamadeh/NEW_PAPER_OLD_DATA/pe_alignment_pipeline/sorted/*.sorted | rev | cut -f1 -d/ | rev | sed 's/\.sorted//g' | parallel --jobs 2 bash "./scripts/04-mark-dup-picard.sh" {}
...
#ls /home/zhamadeh/NEW_PAPER_OLD_DATA/pe_alignment_pipeline/sam/*.sorted.bam| rev | cut -f1 -d/ | rev | parallel --jobs $p bash "./scripts/07-align-met-picard.sh" {}
#./scripts/08-align-met-flagstat.sh
#ls /home/zhamadeh/NEW_PAPER_OLD_DATA/pe_alignment_pipeline/mdup/*.bam | rev | cut -f1 -d/ | rev | parallel --jobs $p bash "./scripts/09-insert-size-picard.sh" {}
#ls /home/zhamadeh/NEW_PAPER_OLD_DATA/pe_alignment_pipeline/mdup/*.bam | rev | cut -f1 -d/ | rev | parallel --jobs $p bash "./scripts/10-gc-bias-picard.sh" {}
